...
def rna_objects(post_tata, cam_x, nucleotide_distance, stretch_rate = 0):
    ...
    transition_top = Cylinder([cam_x + 20, stretch_positive + stretch_rate, 0], [(len(post_tata) * 9), stretch_positive + stretch_rate, 0], 3, models.default_dna_model)
    transition_bot = Cylinder([cam_x + 20, stretch_negative - stretch_rate, 0], [(len(post_tata) * 9), stretch_negative - stretch_rate, 0], 3, models.default_dna_model)
    ...
    for letter in post_tata:
        ...
        nucleotide_distance += 9
    return [transition_top, transition_bot, stretch_top, stretch_bot, nucleotide_top_stretched, nucleotide_bot_stretched]
