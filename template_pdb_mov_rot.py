...
import copy
import argparse
from povray import povray, pdb, load_config, SETTINGS
from vapory import Scene, LightSource, Sphere
...
def scene(step):
    ...
    return Scene(povray.default_camera,
                 objects=[povray.default_light, FRONT_LIGHT] + ethanol.povray_molecule,
                 included=['colors.inc'])
